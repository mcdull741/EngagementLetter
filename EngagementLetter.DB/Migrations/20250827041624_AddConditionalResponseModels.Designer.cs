...
namespace EngagementLetter.DB.Migrations
{
    ...
    [Migration("20250827041624_AddConditionalResponseModels")]
    partial class AddConditionalResponseModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EngagementLetter.Models.ConditionalResponse", b =>
                {
                    ...
                    b.ToTable("ConditionalResponses");
                });

            modelBuilder.Entity("EngagementLetter.Models.ConditionalResponseCondition", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("ConditionalResponseId")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ConditionalResponseId");

                    b.HasIndex("QuestionId");

                    b.HasIndex("QuestionnaireId");

                    b.ToTable("ConditionalResponseConditions");
                });
            ...
            modelBuilder.Entity("EngagementLetter.Models.ConditionalResponseCondition", b =>
                {
                    b.HasOne("EngagementLetter.Models.ConditionalResponse", "ConditionalResponse")
                        .WithMany("Conditions")
                        .HasForeignKey("ConditionalResponseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ConditionalResponse");
